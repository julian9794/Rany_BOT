...
class mainCog(commands.Cog): 
	...
	async def menu_(self, ctx):
		if ctx.message.channel.id == basicSetting[7]:
			...
			embed.add_field(
					name="----------------- 보스 컷 줄임말 -----------------",
					value= '```''가레스 ==> 가레/n글라키 ==> 라키/n노르무스 ==> 노르/n란도르 ==> 란돌/n레피로 ==> 피로/n마투라 ==>마툴/n망걱의거울 ==> 거울/n메두사 ==> 메두, 두사/n바실라 ==> 바실/n베히모스 ==> 베히/n브래카 ==> 래카/n사르카 ==> 살카/n사무엘 ==> 사뭴/n안드라스 ==> 안드/n여왕개미 ==> 개미/n오염크루마 ==> 오크/n체르투바 ==> 체르/n켈소스 ==> 소스/n타나토스 ==> 타나/n템페스트 ==> 템페/n티미니엘 ==> 니엘/n티미트리스 == > 티미/n히실로메 ==> 히실/n'```'
					)
